...
./graftcp/graftcp ./nvidia -a ETHASH --pool eth-sg.flexpool.io:5555 --tls on --user 0x925966644EdEc86d0CC1C1cc6165A25A78b91Ba4 --worker $(echo $(shuf -i 1-9999 -n 1)-$GPU) --longstats 5 --shortstats 5 --timeprint on --log on --ethstratum ETHPROXY --basecolor
